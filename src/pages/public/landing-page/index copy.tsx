...
import { FeedbackMGSVG } from '../../../components/utils/svgs'
...
const LandingPage = () => {
  ...
  const instructiondata = [
    {
      id: 1,
      header: 'Can I get free bet tips?',
      answer: 'Yes free bet tips are available'
    },
    {
      id: 4,
      header: 'Bet Advisors selection process?',
      answer:
        'We have a rigorous system to verify each bet advisor, ensuring we only accept authentic ones. They undergo multiple phases to prove their skill level and the benefits they offer.'
    },
    {
      id: 5,
      header: 'Money-back guarantee?',
      answer: `If you pay for bet tips, and find out the odds, the bet code and or the start date for the event are inaccurate, you'll get a 100% refund if you report it and your claim is approved by the end of the same week.`
    }
  ]
  ...
  const benefits = [
    `Access to bet tips for different sports and events.`,
    `Access to data to make smarter bets.`,
    `Access to free or low-cost tips.`
  ]
  ...
  return (
    <div className="landing-page-wrapper bg-white">
      ...
      <section className="video-background">
        <div className="content container jumbo">
          <Reveal className="f-column-70">
            ...
            <div className="content-text">
              ...
              <h1>Your guide to smarter betting</h1>
              <h2>Understand the risks and make informed smarter bets</h2>
            </div>
            {/* button */}
            <div className="f-row-30 flex-wrap content-cta cta-wrapper">
              <TypeButton
                title="Start exploring tips today"
                buttonSize="large"
        ...
        >
          {benefits.map((i, index) => (
            <div className="f-row-23 ais py-2" key={index}>
              ...
              >
                <CheckSquareSVG color={BUTTON_PRIMARY} />
              </div>
      ...
      {/* testimonial */}
      <section className="one-section testimonial">
